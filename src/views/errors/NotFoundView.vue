      ...
      <div class="relative flex min-h-dvh items-center overflow-hidden bg-white dark:bg-gray-800">
        ...
        >
          <div>
            ...
            <div class="text-6xl font-extrabold text-rose-600 md:text-7xl dark:text-rose-500">
              404
            </div>
            <div
              ...
              aria-hidden="true"
            ></div>
            <h1 class="mb-3 text-2xl font-extrabold md:text-3xl">Bem, isso é estranho...</h1>
            <h2
              class="mx-auto mb-5 font-medium text-gray-500 md:leading-relaxed lg:w-3/5 dark:text-gray-400"
            >
              Parece que não conseguimos encontrar a página que você procura. Talvez ela tenha sido
              movida ou excluída. Desculpe!
            </h2>
          </div>
          <RouterLink
